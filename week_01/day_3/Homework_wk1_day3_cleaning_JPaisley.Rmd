...
- looking at difference in revenue and budget 
- relationship between budget and vote average 
- rekationship between release date and budget
...
```{r}
#creates new variable containing only the requested columns 
...
No missing values in title or budget.
2 missing values in runtime.
...
```{r}
# impute median run time ignoring NA values
